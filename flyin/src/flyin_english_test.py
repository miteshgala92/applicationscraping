...
class Flyinflights:
    ...
    def flights_oneway_data(self, travel_type, origin_code, origin_city, destination_code, destination_city,
...
if __name__ == '__main__':
    ...
    for index, row in oneway_routes_data.iterrows():
        ...
        for nod in no_of_days:
            ...
            flights_data = flyin_app.flights_oneway_data(row['Travel_Type'], row['Origin_Code'], row['Origin_City'],
                                                         row['Destination_Code'], row['Destination_City'],
